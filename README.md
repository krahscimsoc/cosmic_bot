...
4. The /check_info command, which displays various information about the user which uses it, in a form of an embed. The information it dispays are: the profile picture, the main(top) role, 
