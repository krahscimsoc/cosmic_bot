...
First things first, you need to connect the code to the bot itself. You do that by swapping the "Your bot token" text in line 88 for your actual token. Next, you need to swap the "Your guild ID" text for the ID of the guild you want to use the bot in (I haven't tested it in multiple servers yet).
