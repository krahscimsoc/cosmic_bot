...
5. The /button command, which is a test of the buttons. It displays 3 buttons, for now only one of them works. It has a "Click me" text written on it and makes the bot print out 
